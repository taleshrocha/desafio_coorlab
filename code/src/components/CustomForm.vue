<template>
  <form class="flex flex-col justify-center border-2 border-secondary rounded-lg p-4 text-secondary" @submit="onSubmit">
    ...
    <div class="flex flex-col mt-4">
      ...
      <input id="input-2" type="text" v-model="loadweight" class="rounded-full border-gray-300 focus:ring-primary focus:border-primary mt-1.5 p-2" placeholder="Insira o peso" required>
    </div>
